...
?>
<div id="google-business-reviews-rating-settings" class="google-business-reviews-rating gmbrr settings wrap banner<?php echo (($color_scheme ?? 'system') == 'dark') ? ' gmbrr-dark' : ''; ?>" data-color-scheme="<?php echo esc_attr($color_scheme ?? 'system'); ?>">
	<h1><span><?php esc_html_e('Reviews and Rating - Google Reviews', 'g-business-reviews-rating'); ?></span><?php echo ($this->demo) ? ' <span class="demo"><span class="dashicons dashicons-warning"></span> ' . esc_html__('Demo Mode', 'g-business-reviews-rating') . '</span>' : ''; ?></h1>
...
<?php if ($this->section == 'welcome') : ?>
	<section id="welcome" data-errors="<?php echo esc_attr(json_encode([__('A Google API Key and a Place ID are required', 'g-business-reviews-rating'), __('A Google API Key is required', 'g-business-reviews-rating'), __('A Place ID is required', 'g-business-reviews-rating'), __('The Google API Key and Place ID have different values', 'g-business-reviews-rating'), __('An unknown error has a occurred, please reload this page.', 'g-business-reviews-rating')])); ?>">
<?php if ($this->editor) : ?>
        ...
        <form method="post" action="options.php" id="google-business-reviews-rating-settings-welcome" data-nonce="<?php echo esc_attr(wp_create_nonce('gmbrr_nonce_' . $this->section)); ?>">
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <p class="input">
                            <input type="text" id="welcome-api-key" class="regular-text code" name="google_business_reviews_rating_api_key" placeholder="<?php echo esc_attr('AIza' . str_repeat('x', 35)); ?>" value="<?php echo esc_attr(get_option('google_business_reviews_rating_api_key', '')); ?>">
                        </p>
...
Search for <a href="%2$s" class="components-external-link" target="_blank">Places (New) API</a> and click the button to enable this API in your account
...
Under “API restrictions”, select “Restrict Key”, select just “Places (New) API” from the list of options and click “OK”
...
Finally for regular requests, please <a href="%5$s" class="components-external-link" target="_blank">enable billing</a> for your project to receive your <em>substantial and free</em> API request allocation', 'g-business-reviews-rating'), 'https://console.developers.google.com/apis/credentials', 'https://console.cloud.google.com/apis/library/places-backend.googleapis.com?q=place', 'https://console.developers.google.com/apis/credentials', $this->server_ip(), 'https://console.cloud.google.com/projectselector/billing/enable')); ?></li>
                ...
                <tr>
                    ...
                    <td>
                        <p class="input">
                            <input type="text" id="welcome-place-id" class="regular-text code" name="google_business_reviews_rating_place_id" pattern="[B-Za-z][0-9A-Za-z_\-]{15,125}[0-9A-Za-z]" placeholder="<?php echo esc_attr('ChIJ' . str_repeat('x', 23)); ?>" value="<?php echo esc_attr(get_option('google_business_reviews_rating_place_id', '')); ?>">
<?php if (is_array($this->places) && count($this->places) == 1 && isset($this->data['result']['name']) && $this->data['result']['name'] != NULL): ?>
                            <input type="text" id="welcome-place-name" class="regular-text" name="place_name" value="<?php echo esc_attr($this->data['result']['name']); ?>"<?php echo ' style="width: calc(' . (mb_strlen($this->data['result']['name']) + 1) . 'ch + 16px);"'; ?> disabled>
<?php endif; ?>
                        </p>
...
<?php endforeach; ?>
            ...
            <p class="submit">
				<?php submit_button(NULL, 'primary', 'submit', FALSE, ['id' => 'welcome-save']); ?>
...
<?php if ($this->administrator) : ?>
    <section id="general"<?php $general_classes = trim((($this->section != NULL) ? 'hide ' : '') . ((preg_match('/\bdark\b/i', $this->get_theme())) ? 'dark ' : '') . ((preg_match('/\bfonts\b/i', $this->get_theme())) ? 'fonts' : '')); echo ($general_classes != '') ? ' class="' . esc_attr($general_classes) . '"' : ''; echo ($this->data_hunter('boolean')) ? ' data-hunter="' . esc_attr($this->data_hunter('json')) . '"' : ''; ?>>
...
<?php echo $this->notification(); ?>
            ...
            <table id="reviews-rating-settings" class="form-table">
                <tr>
                    ...
                    <td>
                        <select id="reviews-theme" name="google_business_reviews_rating_theme"<?php echo ((!preg_match('/^(?:[12]|(?:compress|minif[iy])(?:ed)?)$/i', get_option('google_business_reviews_rating_stylesheet', 1))) ? ' disabled="disabled"' : ''); ?>>
							<option value=""<?php echo ($this->get_theme() == NULL) ? ' selected' : ''; ?>><?php esc_html_e('Default', 'g-business-reviews-rating'); ?></option>
<?php foreach ($this->reviews_themes as $k => $name) : ?>
                            <option value="<?php echo esc_attr($k); ?>"<?php echo ($this->get_theme() == $k) ? ' selected' : ''; ?>><?php echo esc_attr($name); ?></option>
<?php endforeach; ?>
                        </select>
...
<?php endforeach; ?>
                ...
                <tr>
                    ...
                    <td>
                        <span id="shortcode-short" class="shortcode" contenteditable="true" spellcheck="false">[reviews_rating]</span>
            ...
            <div id="reviews-rating-preview" class="google-business-reviews-rating-preview hide<?php $theme_current = $this->get_theme(); $reviews_color_scheme = get_option('google_business_reviews_rating_color_scheme', ''); echo esc_attr((preg_match('/\bdark\b/i', $theme_current) ? '' : ' light') . (($theme_current != NULL) ? ' ' . $theme_current : '') . (($reviews_color_scheme != NULL) ? ' ' . $reviews_color_scheme : '')); ?>">
            </div>
...
<?php else: ?>
            ...
            <input type="hidden" id="reviews-theme" name="google_business_reviews_rating_theme" value="<?php echo esc_attr($this->get_theme()); ?>">
...
<?php endif; ?>
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <p class="input">
                            <input type="text" id="api-key" class="regular-text code" name="google_business_reviews_rating_api_key" placeholder="<?php echo esc_attr('AIza' . str_repeat('x', 35)); ?>" value="<?php echo esc_attr(get_option('google_business_reviews_rating_api_key', '')); ?>">
                        </p>
                        <p class="description<?php echo ((get_option('google_business_reviews_rating_api_key', '') == NULL) ? ' unset' : ''); ?>"><?php /* translators: 1: URL of Place ID Finder, 2: IP of the web server, 3: Help icon and reveal toggle link */ 
						echo sprintf(__('To retrieve data from Google My Business, you’ll need your <a href="%1$s" class="components-external-link" target="_blank">API Key</a> restricted to the API: <span class="highlight">Places (New) API</span> and IP address: <span class="highlight">%2$s</span> %3$s', 'g-business-reviews-rating'), 'https://developers.google.com/maps/documentation/javascript/get-api-key', esc_html($this->server_ip()), ' <a id="google-credentials-help" href="#google-credentials-steps"><span class="dashicons dashicons-editor-help"></span></a>'); ?></p>
...
<?php if (!is_array($this->places) || is_array($this->places) && count($this->places) <= 1): ?>
                            <input type="text" id="place-id" class="regular-text code" name="google_business_reviews_rating_place_id" pattern="[B-Za-z][0-9A-Za-z_\-]{15,125}[0-9A-Za-z]" placeholder="<?php echo esc_attr('ChIJ' . str_repeat('x', 23)); ?>" value="<?php echo esc_attr(get_option('google_business_reviews_rating_place_id', '')); ?>">
<?php endif; ?>
<?php if (is_array($this->places) && count($this->places) == 1 && isset($this->data['result']['name']) && $this->data['result']['name'] != NULL): ?>
                            <input type="text" id="place-name" class="regular-text" name="place_name" value="<?php echo esc_attr($this->data['result']['name']); ?>"<?php echo ' style="width: calc(' . (mb_strlen($this->data['result']['name']) + 1) . 'ch + 16px);"'; ?> disabled>
...
<?php endif; ?>
                                <li class="place-id<?php echo (get_option('google_business_reviews_rating_place_id', '') == $a['place_id']) ? ' current' : ''; ?>" data-place-id="<?php echo esc_attr($a['place_id']); ?>">
                                    <label for="<?php echo esc_attr('place-id-' . ($i + 1)); ?>" class="current">
                                        ...
                                        <span class="reference"><?php echo esc_html('P' . ($i + 1)); ?></span>
                                    </label>
...
<?php endforeach; ?>
                                <li class="place-id new<?php echo (get_option('google_business_reviews_rating_place_id', '') == NULL) ? ' current' : ''; ?>">
                                    <label for="place-id-new" class="current">
                                        <input type="radio" id="place-id-new" name="google_business_reviews_rating_place_id" value="" aria-label="<?php esc_attr_e('Use a new Place ID', 'g-business-reviews-rating'); ?>"<?php echo ((get_option('google_business_reviews_rating_place_id', '') == NULL) ? ' checked="checked"' : ''); ?>>
                                        <span class="reference new" aria-hidden="true">✳</span>
                                    </label>
                                    <label for="place-id" class="place-id">
                                        <input type="text" id="place-id" class="regular-text code" name="google_business_reviews_rating_place_id_new" pattern="[B-Za-z][0-9A-Za-z_\-]{15,125}[0-9A-Za-z]" placeholder="<?php echo esc_attr('ChIJ' . str_repeat('x', 23)); ?>" value="">
                                    </label>
                                </li>
                            </ul>
<?php endif; ?>
...
<?php if ($this->api_version != NULL): ?>
                        <p class="description"><?php esc_html_e('Google translates the review text into this language. It doesn’t change which reviews are selected.', 'g-business-reviews-rating'); ?></p>
<?php else: ?>
                        <p class="description"><?php esc_html_e('This influences which reviews Google returns as well as their wording.', 'g-business-reviews-rating'); ?></p>
<?php endif; ?>
                    </td>
                </tr>
<?php if ($this->api_version == NULL): ?>
...
<?php endif; ?>
    ...
    <section id="shortcodes"<?php echo ($this->section != 'shortcodes') ? ' class="hide"' : ''; ?>>
        <nav class="section-bookmarks">
            <ul>
        ...
        <form method="post" action="options.php" id="google-business-reviews-rating-shortcodes">
                ...
                <div class="left">
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td><span id="<?php $id = 0; echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false">[reviews_rating]</span></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e('Google reviews (IDs)', 'g-business-reviews-rating'); ?></th>
                            <td><span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false">[reviews_rating id=&quot;1,5,3&quot;]</span></td>
                        </tr>
                        <tr>
                            <th rowspan="10"><?php esc_html_e('Google reviews (options)', 'g-business-reviews-rating'); ?></th>
                            <td>
                            	<span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode abbreviated" contenteditable="true" spellcheck="false">[reviews_rating theme=&quot;dark&quot; min=3 max=5 offset=0 limit=3 summary=&quot;yes&quot; icon=&quot;no&quot; excerpt=160 more=&quot;read more&quot;]</span>
                            	<span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode additional" contenteditable="true" spellcheck="false">[reviews_rating language=&quot;nl&quot; review_word=&quot;recensie/recensies&quot;]</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            	<span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode abbreviated" contenteditable="true" spellcheck="false">[reviews_rating theme=&quot;columns three fonts&quot; vicinity=&quot;E4, London&quot; reviews_link=&quot;View Google Reviews&quot; write_review_link=&quot;Leave A Review&quot;]</span>
                            	<span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode additional" contenteditable="true" spellcheck="false">[reviews_rating theme=&quot;dark&quot; min=3 max=5 offset=0 limit=3]</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            	<span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode abbreviated" contenteditable="true" spellcheck="false">[reviews_rating icon=&quot;/wp-content/uploads/logo.png&quot; avatar=&quot;false&quot; review_item_order=&quot;text first&quot; review_text_min=200]</span>
                            	<span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode additional" contenteditable="true" spellcheck="false">[reviews_rating summary=&quot;yes&quot; icon=&quot;no&quot; excerpt=160 more=&quot;read more&quot;]</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            	<span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode abbreviated" contenteditable="true" spellcheck="false">[reviews_rating place_id=&quot;ChIJtTeDfh9w5kcRJEWRKN1Yy6I&quot; animate=&quot;no&quot; review_text=&quot;no&quot; attribution=&quot;yes&quot;]</span>
                            	<span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode additional" contenteditable="true" spellcheck="false">[reviews_rating theme=&quot;columns three fonts&quot; reviews_link=&quot;View Google Reviews&quot; write_review_link=&quot;Leave A Review&quot;]</span>
                            </td>
                        </tr>
                        <tr class="additional">
                            <td><span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false">[reviews_rating avatar=&quot;false&quot; review_item_order=&quot;text first&quot; review_text_min=200]</span></td>
                        </tr>
                        <tr class="additional">
                            <td><span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false">[reviews_rating icon=&quot;/wp-content/uploads/logo.png&quot; name=&quot;Star Consultancy&quot; vicinity=&quot;E4, London&quot;]</span></td>
                        </tr>
                        <tr class="additional">
                            <td><span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false">[reviews_rating place_id=&quot;ChIJaxhvijEFdkgRPtwPZgzI4w8&quot; animate=&quot;no&quot; review_text=&quot;no&quot;]</span></td>
                        </tr>
                        <tr class="additional">
                            <td><span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false">[reviews_rating summary=false date=false limit=3 min=5 review_text_min=140 review_text_max=290 name_format=&quot;last initial&quot;]</span></td>
                        </tr>
                        <tr class="additional">
                            <td><span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false">[reviews_rating theme=&quot;bubble center fill columns three&quot; summary=false limit=3 min=5 excerpt=150]</span></td>
                        </tr>
                        <tr class="additional">
                            <td><span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false">[reviews_rating theme=&quot;narrow center&quot; summary=&quot;icon, name, rating, stars, count&quot; limit=0 stars=&quot;css&quot;]</span></td>
                        </tr>
                    </table>
                </div>
                <div class="right">
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td><span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false"><?php echo esc_html('[reviews_rating_link reviews_link]' . __('Our Reviews on Google', 'g-business-reviews-rating') . '[/reviews_rating_link]'); ?></span></td>
                        </tr>
                        <tr>
                            <th rowspan="3"><?php esc_html_e('Google reviews link (options)', 'g-business-reviews-rating'); ?></th>
                            <td><span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false"><?php echo esc_html('[reviews_rating_link reviews_link class="button" target="_blank"]' . __('Our Reviews on Google', 'g-business-reviews-rating') . '[/reviews_rating_link]'); ?></span></td>
                        </tr>
                        <tr>
                            <td><span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false"><?php echo esc_html('[reviews_rating_link reviews_link]&lt;span class=&quot;google-icon&quot;&gt;&lt;/span&gt; ' . __('Our Reviews on Google', 'g-business-reviews-rating') . '[/reviews_rating_link]'); ?></span></td>
                        </tr>
                        <tr>
                            <td><span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false"><?php echo esc_html('[reviews_rating_link reviews_link]' . __('Our Reviews on Google', 'g-business-reviews-rating') . ' &lt;span class=&quot;google-icon black end&quot;&gt;&lt;/span&gt;[/reviews_rating_link]'); ?></span></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e('Write a Google review link', 'g-business-reviews-rating'); ?></th>
                            <td><span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false"><?php echo esc_html('[reviews_rating_link write_review_link]' . __('Leave Your Review on Google', 'g-business-reviews-rating') . '[/reviews_rating_link]'); ?></span></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e('Google Maps link', 'g-business-reviews-rating'); ?></th>
                            <td><span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false"><?php echo esc_html('[reviews_rating_link maps_link]' . __('View Location on Google Maps', 'g-business-reviews-rating') . '[/reviews_rating_link]'); ?></span></td>
                        </tr>
                    </table>
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td><span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false">[reviews_rating rating]</span></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e('Google review count', 'g-business-reviews-rating'); ?></th>
                            <td><span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false">[reviews_rating review_count]</span></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e('Google reviews URL', 'g-business-reviews-rating'); ?></th>
                            <td><span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false">[reviews_rating reviews_url]</span></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e('Write a Google review URL', 'g-business-reviews-rating'); ?></th>
                            <td><span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false">[reviews_rating write_review_url]</span></td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e('Google Maps URL', 'g-business-reviews-rating'); ?></th>
                            <td><span id="<?php echo esc_attr('shortcode-' . $id); $id++; ?>" class="shortcode" contenteditable="true" spellcheck="false">[reviews_rating maps_url]</span></td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <table class="wp-list-table widefat fixed striped parameters">
                ...
                <tr id="parameter-type">
                    ...
                    <td class="description"><?php /* translators: 1: shortcode attribute keyword example, 2: another shortcode attribute keyword example */ echo sprintf(__('Set the output type for the shortcode. Types can also be passed directly as a valueless attribute (e.g. <em>%1$s</em> or <em>%2$s</em>) instead of using this parameter.', 'g-business-reviews-rating'), 'maps_link', 'rating_count'); ?></td>
                    <td class="accepted"><span class="code">NULL</span>, reviews, rating, rating_count, review_count, maps_link, maps_url, structured_data, reviews_link, write_review_link, reviews_url, write_review_url</td>
                ...
                <tr id="parameter-place-id">
                    ...
                    <td class="accepted"><em><?php esc_html_e('String', 'g-business-reviews-rating'); ?></em></td>
                    <td class="default"><span class="code">NULL</span></td>
                    <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                    <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                </tr>
                <tr id="parameter-language">
                    ...
                    <td class="accepted"><?php /* translators: example two character language codes, lowercase, start with local language */ _e('en, fr, de, …', 'g-business-reviews-rating'); ?></td>
                    <td class="default"><span class="code">NULL</span></td>
                    <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                    <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                </tr>
                ...
                <tr id="parameter-local-images">
                    <td class="parameter">local_images</td>
                    <td class="description"><?php _e('Load the business icon and reviewer avatars from locally stored copies rather than Google&rsquo;s CDN. Recommended for GDPR compliance and performance. Requires images to have been previously imported.', 'g-business-reviews-rating'); ?></td>
                    <td class="accepted">yes, no, true, false, <span class="code">1</span>, <span class="code">0</span>, show, hide, on, off, local</td>
                    <td class="default"><span class="code">NULL</span></td>
                    <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                    <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                </tr>
                <tr id="parameter-name-format">
                    ...
                    <td class="accepted"><span class="code">NULL</span>, &quot;capitalize&quot;, &quot;lowercase&quot;, &quot;uppercase&quot;, &quot;full name&quot;, &quot;first name&quot;, &quot;last name&quot;, &quot;intials&quot;, &quot;first initial&quot;, &quot;last initial&quot;, &quot;intials with dots&quot;, &quot;first initial with dot&quot;, &quot;last initial with dot&quot;, &quot;initials with dots and space&quot;,  &quot;first initial with dot and space&quot;, &quot;last initial with dot and space&quot;</td>
                ...
                <tr id="parameter-interval">
                    ...
                    <td class="accepted"><span class="code">0.3</span> – <span class="code">50</span></td>
                    <td class="default"><span class="code">NULL</span></td>
                    <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                    <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                </tr>
                <tr id="parameter-transition">
                    <td class="parameter">transition</td>
                    <td class="description"><?php /* translators: 1: bookmark for view parameter, 2: view parameter name */ echo sprintf(__('Set a CSS transition class name for carousel slide changes. Ensure the carousel is active with <a href="%1$s">%2$s</a>.', 'g-business-reviews-rating'), '#parameter-view', 'view'); ?></td>
                    <td class="accepted"><em><?php esc_html_e('Any valid CSS class string', 'g-business-reviews-rating'); ?></em></td>
                    <td class="default"><span class="code">NULL</span></td>
                    <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                    <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                </tr>
                <tr id="parameter-transition-duration">
                    <td class="parameter">transition_duration</td>
                    <td class="description"><?php /* translators: 1: bookmark for view parameter, 2: view parameter name, 3: bookmark for transition parameter, 4: transition parameter name */ echo sprintf(__('Duration in seconds for the carousel slide transition. Requires <a href="%1$s">%2$s</a> and <a href="%3$s">%4$s</a> to be set.', 'g-business-reviews-rating'), '#parameter-view', 'view', '#parameter-transition', 'transition'); ?></td>
                    <td class="accepted"><em><?php esc_html_e('Float:', 'g-business-reviews-rating'); ?></em> <span class="code">0.05</span> – <span class="code">10</span></td>
                    <td class="default"><span class="code">NULL</span></td>
                    <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                    <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                </tr>
                ...
                <tr id="parameter-cursor">
                    <td class="parameter">cursor</td>
                    <td class="description"><?php /* translators: 1: bookmark for view parameter, 2: view parameter name */ echo sprintf(__('Enable or disable cursor and touch-swipe navigation for a carousel. Ensure the carousel is active with <a href="%1$s">%2$s</a>.', 'g-business-reviews-rating'), '#parameter-view', 'view'); ?></td>
                    <td class="accepted">yes, no, true, false, <span class="code">1</span>, <span class="code">0</span>, show, hide, on, off, left, right, both</td>
                    <td class="default"><span class="code">TRUE</span></td>
                    <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                    <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                </tr>
                <tr id="parameter-draggable">
                    <td class="parameter">draggable</td>
                    <td class="description"><?php /* translators: 1: bookmark for view parameter, 2: view parameter name */ echo sprintf(__('Enable or disable drag and swipe navigation for a carousel. Ensure the carousel is active with <a href="%1$s">%2$s</a>.', 'g-business-reviews-rating'), '#parameter-view', 'view'); ?></td>
                    <td class="accepted">yes, no, true, false, <span class="code">1</span>, <span class="code">0</span>, show, hide, on, off, left, right, both</td>
                    <td class="default"><span class="code">TRUE</span></td>
                    <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                    <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                ...
                <tr id="parameter-outer-tag">
                    <td class="parameter">outer_tag</td>
                    <td class="description"><?php /* translators: 1: type parameter value for structured data output */ echo sprintf(__('Toggle the outer wrapper element around the <span class="code">%s</span> output. Set to false to return the raw JSON-LD without a wrapping tag.', 'g-business-reviews-rating'), 'structured_data'); ?></td>
                    <td class="accepted">yes, no, true, false, <span class="code">1</span>, <span class="code">0</span>, show, hide, on, off</td>
                    <td class="default"><span class="code">TRUE</span></td>
                    <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                    <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                ...
                <tr id="parameter-multiplier">
                    ...
                    <td class="accepted"><em><?php esc_html_e('Positive float number:', 'g-business-reviews-rating'); ?></em> <span class="code">0.001</span> – <span class="code">10</span></td>
...
<?php if ($this->demo || $this->count_reviews_all > 5) : ?>
        <div class="review-filter">
            ...
            <?php for($rating_value = 5; $rating_value >= 1; $rating_value--) : ?>
                <li id="<?php echo 'review-filter-rating-' . $rating_value; ?>" class="review-rating rating-<?php echo $rating_value; ?> inactive">
                    <a href="<?php echo '#review-filter-rating-' . $rating_value; ?>" class="rating" data-rating="<?php echo $rating_value; ?>" title="<?php /* translators: %u: refers rating number from 1 to 5 */
						printf(esc_attr(_n('%u star', '%u stars', $rating_value, 'g-business-reviews-rating')), $rating_value); ?>">
                        <?php echo str_repeat('★', $rating_value) . '<span class="not">' . str_repeat('★', 5 - $rating_value) . '</span>'; ?>
                    </a>
                    <a href="<?php echo '#review-filter-rating-' . $rating_value; ?>" class="line-holder" data-rating="<?php echo $rating_value; ?>">
                        <span class="line"></span>
                    </a>
                    <a href="<?php echo '#review-filter-rating-' . $rating_value; ?>" class="rating-count" data-rating="<?php echo $rating_value; ?>">0</a>
                </li>
<?php endfor; ?>
            </ul>
        </div>
...
<?php if ($this->administrator && !$this->demo && $this->count_reviews_all > 1) : ?>
        <dialog id="review-order-dialog" class="dialog">
            <form method="dialog">
                <h3><?php esc_html_e('Review Order', 'g-business-reviews-rating'); ?></h3>
                <div class="explanation">
                    <svg class="diagram" viewBox="0 0 368.299 404.644" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
                        <path class="bar" fill="#3f3f3f" d="M4.301 42.785h236.422v37.931H4.301z" opacity=".35"/>
                        <path class="box" fill="#1e1e1e" stroke="#6a63c6" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="4" d="M4.301 101.191h86.853v37.931H4.301z" opacity=".9"/>
                        <path class="bar" fill="#3f3f3f" d="M4.301 159.596h246.552v37.931H4.301z" opacity=".35"/>
                        <path class="box" fill="#1e1e1e" stroke="#d21d54" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="4" d="M4.301 218.001h314.224v37.931H4.301z" opacity=".9"/>
                        <path class="bar" fill="#3f3f3f" d="M4.301 276.406h121.983v37.931H4.301zm0 58.405h158.621v37.931H4.301z" opacity=".35"/>
                        <path fill="#d21d54" d="M323.587 53.458c-16.724-19.153-33.639-32.157-39.835-36.659l11.716-14.604-37.938 1.026 16.931 33.966 7.259-16.92c6.277 4.584 22.685 17.288 38.922 35.9 18.867 21.626 41.357 55.892 41.357 96.317 0 28.449-11.349 50.751-33.73 66.288-.907.63-1.132 1.876-.502 2.783.388.56 1.011.859 1.645.859.394 0 .791-.115 1.139-.357C354.073 205.729 366 182.322 366 152.484c-.001-41.701-23.064-76.868-42.413-99.026"/>
                        <path fill="#736cc4" d="M146.799 151.088c-20.753-19.058-41.239-27.971-45.315-29.609q-.0465-.03-.096-.057l-.008.015c-.396-.158-.61-.236-.625-.239-.966-.165-1.903.392-2.225 1.312-.322.921.072 1.943.926 2.414.132.073.269.129.407.17 2.702 1.044 88.218 36.025 88.218 127.066 0 40.426-22.49 74.691-41.357 96.317-16.237 18.612-32.645 31.316-38.922 35.9l-7.259-16.92-16.931 33.966 37.938 1.024-11.716-14.603c6.196-4.502 23.111-17.506 39.835-36.658 19.348-22.158 42.412-57.325 42.412-99.026-.001-49.169-24.625-82.102-45.282-101.072"/>
                    </svg>
                    <div class="text">
                        <p><?php esc_html_e('Reviews are listed by relevance, not by date. Google no longer lets the plugin ask for a particular order, so relevance is calculated within the plugin itself.', 'g-business-reviews-rating'); ?></p>
                        <p><?php esc_html_e('Reviews assigned using the HTML Import will hold Google’s own ranking, as long as the Google popup has review ordering set to the default: “Most relevant”.', 'g-business-reviews-rating'); ?></p>
                        <p><?php esc_html_e('Arranging by relevance reorders every review using a combination of its age and length.', 'g-business-reviews-rating'); ?></p>
                    </div>
                </div>
                <p class="buttons">
                    <button type="submit" value="cancel" class="button"><?php esc_html_e('Cancel', 'g-business-reviews-rating'); ?></button>
                    <button type="button" id="review-order-import" class="button"><?php esc_html_e('HTML Import', 'g-business-reviews-rating'); ?></button>
                    <button type="button" id="review-order-arrange" class="button button-primary" data-nonce="<?php echo esc_attr(wp_create_nonce('gmbrr_nonce')); ?>"><?php esc_html_e('Arrange by relevance', 'g-business-reviews-rating'); ?></button>
                </p>
            </form>
        </dialog>
<?php endif; ?>
...
<?php if ($this->administrator && $this->retrieved_data_check()): ?>
	<section id="data"<?php echo ($this->section != 'data') ? ' class="hide"' : ''; ?>>
		<h2><?php esc_html_e('Retrieved Data', 'g-business-reviews-rating'); ?></h2>
		<?php echo $this->get_data('html'); ?>
<?php $retrieval_history = $this->get_retrieval_history(10); ?>
<?php if (!empty($retrieval_history)) : ?>
		<h3><?php esc_html_e('Recent Retrievals', 'g-business-reviews-rating'); ?></h3>
		<p class="description"><?php esc_html_e('How often new reviews are actually found, to help you judge the synchronization frequency.', 'g-business-reviews-rating'); ?></p>
		<table class="wp-list-table widefat striped retrieval-history">
			<thead>
				<tr>
					<th scope="col"><?php esc_html_e('Retrieved', 'g-business-reviews-rating'); ?></th>
					<th scope="col" class="place-id"><?php esc_html_e('Place ID', 'g-business-reviews-rating'); ?></th>
					<th scope="col"><?php esc_html_e('Status', 'g-business-reviews-rating'); ?></th>
					<th scope="col" class="number"><?php esc_html_e('Returned', 'g-business-reviews-rating'); ?></th>
					<th scope="col" class="number"><?php esc_html_e('New', 'g-business-reviews-rating'); ?></th>
					<th scope="col" class="number"><?php esc_html_e('Total', 'g-business-reviews-rating'); ?></th>
					<th scope="col"><?php esc_html_e('Source', 'g-business-reviews-rating'); ?></th>
				</tr>
			</thead>
			<tbody>
<?php foreach ($retrieval_history as $retrieval_entry) : ?>
				<tr>
					<td><?php echo esc_html(gmdate('Y/m/d H:i', $retrieval_entry['time'])); ?></td>
					<td class="place-id"><?php echo ($retrieval_entry['place_id'] != NULL) ? '<code>' . esc_html($retrieval_entry['place_id']) . '</code>' : '—'; ?></td>
					<td><?php echo ($retrieval_entry['status'] != NULL) ? esc_html(strval($retrieval_entry['status'])) : '—'; ?></td>
					<td class="number"><?php echo esc_html(number_format_i18n($retrieval_entry['returned'])); ?></td>
					<td class="number<?php echo ($retrieval_entry['added'] > 0) ? ' added' : ''; ?>"><?php echo esc_html(number_format_i18n($retrieval_entry['added'])); ?></td>
					<td class="number"><?php echo ($retrieval_entry['rating_count'] != NULL) ? esc_html(number_format_i18n($retrieval_entry['rating_count'])) : '—'; ?></td>
					<td><?php echo ($retrieval_entry['cron']) ? esc_html__('Scheduled', 'g-business-reviews-rating') : esc_html__('Dashboard', 'g-business-reviews-rating'); ?></td>
				</tr>
<?php endforeach; ?>
			</tbody>
		</table>
...
<?php if ($this->administrator) : ?>
	<section id="advanced"<?php echo ($this->section != 'advanced') ? ' class="hide"' : ''; ?>>
...
<?php endif; ?>
<?php if (!$this->demo && $this->api_version == NULL): ?>
                <li><a href="#advanced-api-version"><?php esc_html_e('API Version Switch', 'g-business-reviews-rating'); ?></a></li>
<?php endif; ?>
                <li><a href="#advanced-theme"><?php esc_html_e('Dashboard Theme', 'g-business-reviews-rating'); ?></a></li>
	...
	echo sprintf(__('
                <div class="entry-content advanced">
                    ...
                    <ol id="html-import-instructions">
                        ...
                        <li>If you see “…More”, you may need to expand these reviews;</li>
                ...
                <div class="entry-meta advanced">
                    <ul id="html-import-figures">
                        <li id="html-import-figure-1"><img src="%2$s" width="1036" height="862" loading="lazy" decoding="async" alt="Fig. 1: Import Step 3, Part 1"><span class="caption"><strong>Fig 1:</strong> In the margin, <span class="right-click">right click</span>.</span></li>
                        <li id="html-import-figure-2"><img src="%3$s" width="1036" height="862" loading="lazy" decoding="async" alt="Fig. 2: Import Step 3, Part 2"><span class="caption"><strong>Fig 2:</strong> Select <em>Inspect</em>.</span></li>
                        <li id="html-import-figure-3"><img src="%4$s" width="1036" height="862" loading="lazy" decoding="async" alt="Fig. 3: Import Step 4"><span class="caption"><strong>Fig 3:</strong> <span class="right-click">Right click</span> on the highlighted &lt;div&gt; tag and click <em>Copy | Outer HTML</em>.</span></li>
                    </ul>
                </div>', 'g-business-reviews-rating'),
                esc_attr('https://search.google.com/local/reviews?placeid=' . $this->place_id),
                esc_attr(google_business_reviews_rating::plugin_url('dashboard/images/advanced-html-import-step-3a.jpg')),
                esc_attr(google_business_reviews_rating::plugin_url('dashboard/images/advanced-html-import-step-3b.jpg')),
                esc_attr(google_business_reviews_rating::plugin_url('dashboard/images/advanced-html-import-step-4.jpg'))); ?>
            </div>
            <p class="html-import">
                ...
                <span id="html-import-review-text" class="input html-import-hide segmented">
                    <label><input type="radio" id="html-import-review-text-original" name="html-import-review-text" value="original" checked="checked"> <?php esc_html_e('Only import original', 'g-business-reviews-rating'); ?></label>
                    <label><input type="radio" id="html-import-review-text-translation" name="html-import-review-text" value="translation"> <?php esc_html_e('Only import translation', 'g-business-reviews-rating'); ?></label>
                    <label><input type="radio" id="html-import-review-text-full" name="html-import-review-text" value=""> <?php esc_html_e('Import full review text', 'g-business-reviews-rating'); ?></label>
                </span>
                ...
                <label id="html-import-relevance-label" class="html-import-hide" for="html-import-relevance"><input type="checkbox" id="html-import-relevance" name="html-import-relevance" value="1"> <?php esc_html_e('Apply Google’s order as relevance', 'g-business-reviews-rating') ?></label>
            </p>
            <p class="submit">
        ...
        <dialog id="relevance-confirm-dialog" class="dialog">
            <form method="dialog">
                <h3><?php esc_html_e('Reorder every review', 'g-business-reviews-rating'); ?></h3>
                <p><?php esc_html_e('Each review is repositioned to match the order Google showed it in, including reviews already stored.', 'g-business-reviews-rating'); ?></p>
                <p><?php esc_html_e('Set the Google popup to Most relevant to apply its current relevancy.', 'g-business-reviews-rating'); ?></p>
                <p class="buttons">
                    <button type="submit" value="cancel" class="button"><?php esc_html_e('Cancel', 'g-business-reviews-rating'); ?></button>
                    <button type="submit" value="confirm" class="button button-primary"><?php esc_html_e('Continue', 'g-business-reviews-rating'); ?></button>
                </p>
            </form>
        </dialog>
        <dialog id="relevance-result-dialog" class="dialog relevance-result-dialog">
            <form method="dialog">
                <h3><?php esc_html_e('Relevance applied', 'g-business-reviews-rating'); ?></h3>
                <p id="relevance-result-message"></p>
                <div id="relevance-result-changes"></div>
                <p class="buttons">
                    <button type="submit" value="close" class="button button-primary"><?php esc_html_e('Close', 'g-business-reviews-rating'); ?></button>
                </p>
            </form>
        </dialog>
<?php else: ?>
...
<?php endif; ?>
<?php if (!$this->demo && $this->api_version == NULL): ?>
        <form method="post" action="options.php" id="google-business-reviews-rating-settings-api-version" class="html-import-hide" data-nonce="<?php echo esc_attr(wp_create_nonce('gmbrr_nonce')); ?>">
            <h3 id="advanced-api-version"><?php esc_html_e('API Version Switch', 'g-business-reviews-rating'); ?></h3>
            <p><?php _e('You are using the original Google Places (New) API. This is being replaced with: Places (New) API over an extended period of time. You can enable Places (New) API in Google Cloud and add this as an API Key restriction. When you are ready to make the switch, please update the plugin’s settings.', 'g-business-reviews-rating'); ?></p>
            <p class="submit">
                <button type="button" name="api-version-update" id="api-version-update-button" class="button button-primary"><?php esc_html_e('Switch to Places (New) API', 'g-business-reviews-rating'); ?></button>
            </p>
        </form>
<?php endif; ?>
        <div id="google-business-reviews-rating-settings-theme" class="html-import-hide" data-nonce="<?php echo esc_attr(wp_create_nonce('gmbrr_nonce')); ?>">
            <h3 id="advanced-theme"><?php esc_html_e('Dashboard Theme', 'g-business-reviews-rating'); ?></h3>
            <p class="input">
                <fieldset id="admin-color-scheme" class="color-scheme segmented">
                    <legend><?php esc_html_e('Color scheme for this dashboard, remembered for your user account.', 'g-business-reviews-rating'); ?></legend>
<?php
                    $color_scheme_options = [
                        'system' => __('System', 'g-business-reviews-rating'),
                        'light' => __('Light', 'g-business-reviews-rating'),
                        'dark' => __('Dark', 'g-business-reviews-rating')
                    ];

                    foreach ($color_scheme_options as $color_scheme_value => $color_scheme_label) :
?>
                    <label for="<?php echo esc_attr('admin-color-scheme-' . $color_scheme_value); ?>"><input type="radio" name="admin-color-scheme" id="<?php echo esc_attr('admin-color-scheme-' . $color_scheme_value); ?>" value="<?php echo esc_attr($color_scheme_value); ?>"<?php checked($color_scheme ?? 'system', $color_scheme_value); ?>> <span><?php echo esc_html($color_scheme_label); ?></span></label>
<?php
                    endforeach;
?>
                </fieldset>
...
<?php endif; ?>
	...
	<section id="about"<?php echo ($this->section != 'about') ? ' class="hide"' : ''; ?>>
        <nav class="section-bookmarks">
            <ul>
...
<?php endif; ?>
    	...
    	<div class="entry-meta">
            ...
            <div class="widget plugin-social">
				...
				<p>
					<a class="button" href="https://x.com/designextreme_" title="<?php esc_attr_e('Follow us on X', 'g-business-reviews-rating'); ?>"><span class="icon icon-x"><svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 1668.56 1221.19" fill="currentColor"><path d="M336.33 142.25 722.72 658.9l-388.83 420.05h87.51l340.42-367.76 275.05 367.76h297.8l-408.13-545.7 361.92-390.99h-87.51l-313.51 338.7-253.31-338.7h-297.8zm128.69 64.46h136.81l604.13 807.76h-136.81L465.02 206.71z"/></svg></span> <?php esc_html_e('Follow Us', 'g-business-reviews-rating'); ?></a>
					<a class="button" href="https://bsky.app/profile/designextreme.bsky.social" title="<?php esc_attr_e('Follow us on Bluesky', 'g-business-reviews-rating'); ?>"><span class="icon icon-bluesky"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 530" fill="currentColor">
  <path d="M135.72 44.03C202.216 93.951 273.74 195.17 300 249.49c26.262-54.316 97.782-155.54 164.28-205.46C512.26 8.009 590-19.862 590 68.825c0 17.712-10.155 148.79-16.111 170.07-20.703 73.984-96.144 92.854-163.25 81.433 117.3 19.964 147.14 86.092 82.697 152.22-122.39 125.59-175.91-31.511-189.63-71.766-2.514-7.3797-3.6904-10.832-3.7077-7.8964-.0174-2.9357-1.1937.51669-3.7077 7.8964-13.714 40.255-67.233 197.36-189.63 71.766-64.444-66.128-34.605-132.26 82.697-152.22-67.108 11.421-142.55-7.4491-163.25-81.433-5.9562-21.282-16.111-152.36-16.111-170.07 0-88.687 77.742-60.816 125.72-24.795z"/>
</svg></span> <?php esc_html_e('Follow Us', 'g-business-reviews-rating'); ?></a>
				</p>
            </div>
            <div class="widget plugin-ratings">
                ...
                <p><a class="button" href="https://wordpress.org/support/plugin/g-business-reviews-rating/reviews/#new-post" target="_blank" data-notification-action="notification rate about" data-nonce="<?php echo esc_attr(wp_create_nonce('gmbrr_nonce')); ?>"><span class="dashicons dashicons-star-filled"></span> <?php esc_html_e('Add My Review', 'g-business-reviews-rating'); ?></a></p>
            </div>
